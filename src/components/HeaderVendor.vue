            ...
            <div v-if="showNotifications" class="dropdown-menu show position-absolute end-0 mt-2 p-2 shadow">
              ...
              <div v-else>
                <a v-for="(notification, index) in notifications" :key="index" href="#"
                  ...
                  <div>
                    <strong class="notification-text">{{ notification.notificationTitle }}</strong> <!-- 显示标题 -->
...
const clearNotifications = async () => {
  try {
    await axios.delete(`http://localhost:8080/api/vendor/notification/delete/${memberId}`);
    notifications.value = [];
  } catch (error) {
